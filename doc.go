...
github.com/HuaweiCloudDeveloper/gaussdb-go/v1/pgxpool for a concurrency safe connection pool.
...
github.com/HuaweiCloudDeveloper/gaussdb-go/v1/pgconn contains a lower level PostgreSQL driver roughly at the level of libpq. pgx.Conn in
